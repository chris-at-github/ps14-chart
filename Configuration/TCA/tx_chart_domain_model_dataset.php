...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:chart/Resources/Private/Language/locallang_db.xlf:tx_chart_domain_model_dataset',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:chart/Resources/Private/Language/locallang_db.xlf:tx_chart_domain_model_dataset.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
        ...
        'color' => [
            'exclude' => true,
            'label' => 'LLL:EXT:chart/Resources/Private/Language/locallang_db.xlf:tx_chart_domain_model_dataset.color',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
